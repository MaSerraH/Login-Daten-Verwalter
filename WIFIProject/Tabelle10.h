...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(362, 31);
			...
			this->btnLöschen->Click += gcnew System::EventHandler(this, &Tabelle10::btnLöschen_Click);
			// 
			// btnReset
			// 
			...
			this->btnSuchen->Font = (gcnew System::Drawing::Font(L"Arial", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnSuchen->Location = System::Drawing::Point(592, 97);
			...
			this->labelID->Font = (gcnew System::Drawing::Font(L"Arial", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->labelID->Location = System::Drawing::Point(826, 37);
			...
			this->tbSuchen->Font = (gcnew System::Drawing::Font(L"Arial", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->tbSuchen->Location = System::Drawing::Point(722, 97);
...
#pragma endregion
	...
	private: System::Void btnAnlegen_Click(System::Object^ sender, System::EventArgs^ e) {
		try {
			...
			//mittels den Command Insert, fügt man den gelesene Inhalt von den Variablen (Name, LoginName, LoginPasswort) in der zugehörigen Spalte der Tabelle(t_10) hinzu
...
private: System::Void btnLöschen_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		//mittel die Abfrage(delete) wird von der Tabelle(t_10) einen ausgewählte Eintrag gelöscht. Das ID ist eindeutig
...
private: System::Void btnUpdate_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		sqlcom->ExecuteNonQuery();
		//die Methode update ist dafür gedacht für den Fall dass man ein Eintrag editieren will, die neue Info wird in den zugehörige Spalte der Tabelle(t_10) in DB aktualisiert
		sqlconn->Close();
		t_10();
...
private: System::Void btnSuchen_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		//man selectiert all die information in der Tabelle t_10 und man speichert diese Information in einem DataAdapter, der DataAdapter wird dann eine DataTable füllen. man erzeugt dann ein Dataview und desen DefaultView wird die DataTable sein

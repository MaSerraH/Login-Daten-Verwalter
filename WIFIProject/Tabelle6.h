...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Users: Konto 6";
			// 
			// linkLabel1
			// 
			this->linkLabel1->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->linkLabel1->Location = System::Drawing::Point(852, 725);
			...
			this->btnTabzeigen->Click += gcnew System::EventHandler(this, &Tabelle6::btnTabzeigen_Click);
			// 
			// btnUpdate
			// 
			...
			this->btnUpdate->Click += gcnew System::EventHandler(this, &Tabelle6::btnUpdate_Click);
			// 
			// btnExport
			// 
			...
			this->btnExport->Click += gcnew System::EventHandler(this, &Tabelle6::btnExport_Click);
			// 
			// panel1
			// 
			...
			this->panel1->Location = System::Drawing::Point(697, 417);
			...
			this->btnNeuSt->Click += gcnew System::EventHandler(this, &Tabelle6::btnNeuSt_Click);
			// 
			// btnAnlegen
			// 
			...
			this->btnAnlegen->Click += gcnew System::EventHandler(this, &Tabelle6::btnAnlegen_Click);
			// 
			// btnLöschen
			// 
			...
			this->btnLöschen->Click += gcnew System::EventHandler(this, &Tabelle6::btnLöschen_Click);
			// 
			// btnReset
			// 
			...
			this->btnReset->Click += gcnew System::EventHandler(this, &Tabelle6::btnReset_Click);
			// 
			// panel2
			// 
			...
			this->panel2->Location = System::Drawing::Point(55, 327);
			...
			this->dataGridView1->Location = System::Drawing::Point(47, 417);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(604, 281);
			this->dataGridView1->TabIndex = 111;
			this->dataGridView1->CellClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Tabelle6::dataGridView1_CellClick);
			// 
			// panel3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Arial", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(62, 182);
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Arial", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(50, 253);
			...
			// tbPass
			// 
			this->tbPass->Location = System::Drawing::Point(302, 240);
			this->tbPass->Name = L"tbPass";
			this->tbPass->Size = System::Drawing::Size(237, 34);
			this->tbPass->TabIndex = 108;
			// 
			// tbName
			// 
			this->tbName->Location = System::Drawing::Point(302, 174);
			...
			// tbNameIn
			// 
			this->tbNameIn->Location = System::Drawing::Point(302, 104);
			this->tbNameIn->Name = L"tbNameIn";
			this->tbNameIn->Size = System::Drawing::Size(237, 34);
			this->tbNameIn->TabIndex = 106;
			// 
			// label2
			// 
			...
			this->ClientSize = System::Drawing::Size(963, 763);
...
#pragma endregion
	private:System::Void t_6()
	{
		...
		sqlcom->CommandText = "select * from t_6";
		MySqlDataReader^ sqlrd = sqlcom->ExecuteReader();
		//Man liest den Inhalt der Tabelle(t_6) mittels ein Reader
	...
	private: System::Void btnAnlegen_Click(System::Object^ sender, System::EventArgs^ e) {
		try {
			...
			//mittels den Command Insert, fügt man den gelesene Inhalt von den Variablen (Name, LoginName, LoginPasswort) in der zugehörigen Spalte der Tabelle(t_6) hinzu
			sqlcom->CommandText = "insert into t_6(Name, LoginName, LoginPasswort)" + "values('" + nameInt + "','" + nameLog + "', '" + passLog + "')";
...
private: System::Void btnLöschen_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		//mittel die Abfrage(delete) wird von der Tabelle(t_6) einen ausgewählte Eintrag gelöscht. Das ID ist eindeutig
		MySqlCommand^ sqlcmd = gcnew MySqlCommand("DELETE FROM t_6 WHERE ID=" + ID + "", sqlconn);
...
private: System::Void btnNeuSt_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		MySqlCommand^ sqlcmd = gcnew MySqlCommand("truncate table t_6", sqlconn);
		sqlcmd->ExecuteNonQuery();
...
private: System::Void btnUpdate_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		sqlcom->CommandText = "update t_6 set Name='" + nameInt + "', LoginName='" + nameLog + "', LoginPasswort='" + passLog + "' where ID= " + ID + "", sqlconn;
		sqlcom->ExecuteNonQuery();
		//die Methode update ist dafür gedacht für den Fall dass man ein Eintrag editieren will, die neue Info wird in den zugehörige Spalte der Tabelle(t_6) in DB aktualisiert
		sqlconn->Close();
		t_6();
...
private: System::Void btnSuchen_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		MySqlDataAdapter^ sda = gcnew MySqlDataAdapter("select * from t_6", sqlconn);


		DataTable^ sqlDt = gcnew DataTable();
		sda->Fill(sqlDt);
		DataView^ dv = sqlDt->DefaultView;
		//man selectiert all die information in der Tabelle t_6 und man speichert diese Information in einem DataAdapter, der DataAdapter wird dann eine DataTable füllen. man erzeugt dann ein Dataview und desen DefaultView wird die DataTable sein
...
private: System::Void btnTabzeigen_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		MySqlDataAdapter^ sqlDtA = gcnew MySqlDataAdapter("select * from t_6", sqlconn);
		DataTable^ sqlDt = gcnew DataTable();
		sqlDtA->Fill(sqlDt);
		dataGridView1->DataSource = sqlDt;
...
private: System::Void btnExport_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		sqlcom->CommandText = "select 'ID', 'Name', 'LoginName', 'LoginPasswort' union select ID, Name, LoginName, LoginPasswort from t_6 into outfile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/t6.csv' fields terminated by ';'", sqlconn;
		sqlcom->ExecuteNonQuery();
		sqlconn->Close();
		t_6();
	}

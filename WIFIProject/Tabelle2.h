...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(107, 60);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(197, 33);
			this->label1->TabIndex = 3;
			this->label1->Text = L"User_Konto 2";
			// 
			// linkLabel1
			// 
			this->linkLabel1->Font = (gcnew System::Drawing::Font(L"Arial", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->linkLabel1->Location = System::Drawing::Point(454, 488);
			...
			this->ClientSize = System::Drawing::Size(611, 558);

...
namespace WIFIProject {
	...
	/// <summary>
	/// Zusammenfassung für Tabelle3
	/// </summary>
	public ref class Tabelle3 : public System::Windows::Forms::Form
	{
	public:
		Tabelle3(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(338, 24);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(214, 33);
			this->label1->TabIndex = 3;
			this->label1->Text = L"Users: Konto 3";
			// 
			// linkLabel1
			// 
			...
			this->linkLabel1->Location = System::Drawing::Point(801, 723);
			this->linkLabel1->Name = L"linkLabel1";
			this->linkLabel1->Size = System::Drawing::Size(115, 29);
			this->linkLabel1->TabIndex = 2;
			this->linkLabel1->TabStop = true;
			this->linkLabel1->Text = L"zum H-F";
			this->linkLabel1->LinkClicked += gcnew System::Windows::Forms::LinkLabelLinkClickedEventHandler(this, &Tabelle3::linkLabel1_LinkClicked);
			// 
			// btnTabzeigen
			// 
			...
			this->btnTabzeigen->Click += gcnew System::EventHandler(this, &Tabelle3::btnTabzeigen_Click);
			// 
			// btnExport
			// 
			...
			this->btnExport->Click += gcnew System::EventHandler(this, &Tabelle3::btnExport_Click);
			// 
			// btnSuchen
			// 
			this->btnSuchen->Font = (gcnew System::Drawing::Font(L"Arial", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnSuchen->Location = System::Drawing::Point(630, 81);
			this->btnSuchen->Name = L"btnSuchen";
			this->btnSuchen->Size = System::Drawing::Size(99, 39);
			this->btnSuchen->TabIndex = 71;
			this->btnSuchen->Text = L"Suchen";
			this->btnSuchen->UseVisualStyleBackColor = true;
			this->btnSuchen->Click += gcnew System::EventHandler(this, &Tabelle3::btnSuchen_Click);
			// 
			// labelID
			// 
			this->labelID->Font = (gcnew System::Drawing::Font(L"Arial", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->labelID->Location = System::Drawing::Point(751, 141);
			this->labelID->Name = L"labelID";
			this->labelID->Size = System::Drawing::Size(39, 29);
			...
			this->tbSuchen->Font = (gcnew System::Drawing::Font(L"Arial", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->tbSuchen->Location = System::Drawing::Point(567, 31);
			this->tbSuchen->Name = L"tbSuchen";
			this->tbSuchen->Size = System::Drawing::Size(221, 34);
			this->tbSuchen->TabIndex = 70;
			// 
			// btnUpdate
			// 
			...
			this->btnUpdate->Click += gcnew System::EventHandler(this, &Tabelle3::btnUpdate_Click);
			// 
			// panel1
			// 
			...
			this->panel1->Location = System::Drawing::Point(674, 427);
			...
			this->btnNeuSt->Click += gcnew System::EventHandler(this, &Tabelle3::btnNeuSt_Click);
			// 
			// btnAnlegen
			// 
			...
			this->btnAnlegen->Click += gcnew System::EventHandler(this, &Tabelle3::btnAnlegen_Click);
			// 
			// btnLöschen
			// 
			...
			this->btnLöschen->Click += gcnew System::EventHandler(this, &Tabelle3::btnLöschen_Click);
			// 
			// btnReset
			// 
			...
			this->btnReset->Click += gcnew System::EventHandler(this, &Tabelle3::btnReset_Click);
			// 
			// panel2
			// 
			...
			this->panel2->Location = System::Drawing::Point(32, 337);
			...
			this->dataGridView1->Location = System::Drawing::Point(24, 427);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(604, 281);
			this->dataGridView1->TabIndex = 72;
			this->dataGridView1->CellClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Tabelle3::dataGridView1_CellClick);
			// 
			// label4
			// 
			...
			// tbPass
			// 
			this->tbPass->Location = System::Drawing::Point(360, 230);
			this->tbPass->Name = L"tbPass";
			this->tbPass->Size = System::Drawing::Size(237, 34);
			this->tbPass->TabIndex = 69;
			// 
			// tbName
			// 
			this->tbName->Location = System::Drawing::Point(363, 172);
			...
			// tbNameIn
			// 
			this->tbNameIn->Location = System::Drawing::Point(362, 120);
			this->tbNameIn->Name = L"tbNameIn";
			this->tbNameIn->Size = System::Drawing::Size(237, 34);
			this->tbNameIn->TabIndex = 67;
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Arial", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(198, 180);
			...
			this->panel3->Location = System::Drawing::Point(10, 409);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Arial", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(87, 128);
			...
			this->panel4->Location = System::Drawing::Point(75, 99);
			this->panel4->Name = L"panel4";
			this->panel4->Size = System::Drawing::Size(798, 188);
			...
			this->ClientSize = System::Drawing::Size(970, 776);
			...
			this->Name = L"Tabelle3";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"User Konto 3";
...
#pragma endregion
		private:System::Void t_3()
		{
			...
			sqlcom->CommandText = "select * from t_3";
	...
	private: System::Void btnAnlegen_Click(System::Object^ sender, System::EventArgs^ e) {
		try {
			...
			//mittels den Command Insert, fügt man den gelesene Inhalt von den Variablen (Name, LoginName, LoginPasswort) in der zugehörigen Spalte der Tabelle(t_3) hinzu
			sqlcom->CommandText = "insert into t_3(Name, LoginName, LoginPasswort)" + "values('" + nameInt + "','" + nameLog + "', '" + passLog + "')";
...
private: System::Void btnLöschen_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		//mittel die Abfrage(delete) wird von der Tabelle(t_3) einen ausgewählte Eintrag gelöscht. Das ID ist eindeutig
		MySqlCommand^ sqlcmd = gcnew MySqlCommand("DELETE FROM t_3 WHERE ID=" + ID + "", sqlconn);
...
private: System::Void btnNeuSt_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		MySqlCommand^ sqlcmd = gcnew MySqlCommand("truncate table t_3", sqlconn);
		sqlcmd->ExecuteNonQuery();
...
private: System::Void btnUpdate_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		sqlcom->CommandText = "update t_3 set Name='" + nameInt + "', LoginName='" + nameLog + "', LoginPasswort='" + passLog + "' where ID= " + ID + "", sqlconn;
		sqlcom->ExecuteNonQuery();
		//die Methode update ist dafür gedacht für den Fall dass man ein Eintrag editieren will, die neue Info wird in den zugehörige Spalte der Tabelle(t_3) in DB aktualisiert
		sqlconn->Close();
		t_3();
...
private: System::Void btnSuchen_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		MySqlDataAdapter^ sda = gcnew MySqlDataAdapter("select * from t_3", sqlconn);


		DataTable^ sqlDt = gcnew DataTable();
		sda->Fill(sqlDt);
		DataView^ dv = sqlDt->DefaultView;
		//man selectiert all die information in der Tabelle t_3 und man speichert diese Information in einem DataAdapter, der DataAdapter wird dann eine DataTable füllen. man erzeugt dann ein Dataview und desen DefaultView wird die DataTable sein
...
private: System::Void btnTabzeigen_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		MySqlDataAdapter^ sqlDtA = gcnew MySqlDataAdapter("select * from t_3", sqlconn);
		DataTable^ sqlDt = gcnew DataTable();
		sqlDtA->Fill(sqlDt);
		dataGridView1->DataSource = sqlDt;
...
private: System::Void btnExport_Click(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		sqlcom->CommandText = "select 'ID', 'Name', 'LoginName', 'LoginPasswort' union select ID, Name, LoginName, LoginPasswort from t_3 into outfile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/t3.csv' fields terminated by ';'", sqlconn;
		sqlcom->ExecuteNonQuery();
		sqlconn->Close();
		t_3();
	}
